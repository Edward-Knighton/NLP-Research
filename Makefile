...
OBJS = args.o dictionary.o productquantizer.o matrix.o qmatrix.o vector.o model.o utils.o fasttext.o preprocess.o
INCLUDES = -I.
...
preprocess.o: src/preprocess.cc
	$(CXX) $(CXXFLAGS) -c src/preprocess.cc
